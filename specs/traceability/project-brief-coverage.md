...
| Domain entities: organizations, users, memberships, groups, projects, tokens, memory entries, evidence, grants, audit events | `specs/domain/model.md`, `specs/data/schema.dbml` |
...
| Authentication, personal API tokens, token scopes, max visibility, token behavior | `specs/security/authorization.md`, `specs/api/rest-api.md`, `specs/features/auth_and_tokens.feature` |
