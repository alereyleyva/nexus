...
| Technical architecture, stack, repository layout, module structure, code quality, style, dependencies, migrations, CI | `standards/backend/repository-structure.md`, `standards/backend/internal-services.md`, `standards/python/code-quality.md`, `standards/python/style.md`, `standards/dependency-management.md`, `standards/database-migrations.md`, `standards/ci-quality-gates.md`, `docs/adr/0001-modular-monolith-api-first.md` |
| Internal service responsibilities: auth, authorization, memory, search, context packs, audit | `standards/backend/internal-services.md` |
...
| Mandatory testing, invariants, search/context/audit tests | `standards/testing.md`, `specs/features/*.feature` |
...
| Acceptance criteria | `specs/product/overview.md`, `standards/testing.md`, `specs/features/*.feature` |
| AI implementation prompt and agent workflow | `standards/ai-implementation-prompt.md`, `standards/agent-workflow.md`, `AGENTS.md` |
